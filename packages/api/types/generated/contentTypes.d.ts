...
export interface ApiAttendanceClaimAttendanceClaim
  extends Struct.CollectionTypeSchema {
...
export interface ApiBudgetLineItemBudgetLineItem
  extends Struct.CollectionTypeSchema {
...
export interface ApiDiscountCodeDiscountCode
  ...
  info: {
    description: 'Promotional discount codes for event tickets';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    createdByPlayer: Schema.Attribute.Relation<
      'manyToOne',
      'api::player.player'
    >;
    description: Schema.Attribute.Text;
...
export interface ApiEventLocationEventLocation
  ...
  attributes: {
    ...
    location: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<'global::map-field'>;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    budgetItems: Schema.Attribute.Relation<
      'oneToMany',
      'api::budget-line-item.budget-line-item'
    >;
    ...
    registration: Schema.Attribute.Component<
      ...
      false
    >;
    resultItems: Schema.Attribute.Relation<
      'oneToMany',
    ...
    stripeAccount: Schema.Attribute.Relation<
      'manyToOne',
      'api::stripe-account.stripe-account'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    ticketingMode: Schema.Attribute.Enumeration<
    ...
    ticketTypes: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProcessedWebhookProcessedWebhook
  extends Struct.CollectionTypeSchema {
...
export interface ApiResultLineItemResultLineItem
  extends Struct.CollectionTypeSchema {
...
export interface ApiStripeAccountStripeAccount
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    chargesEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    country: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 2;
    ...
    detailsSubmitted: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTicketOrderTicketOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attendeeDetails: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    gdprConsentTimestamp: Schema.Attribute.DateTime;
    hasReservation: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    paymentProvider: Schema.Attribute.Enumeration<['stripe', 'manual']> &
      Schema.Attribute.Required;
    player: Schema.Attribute.Relation<'manyToOne', 'api::player.player'>;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attendeeEmail: Schema.Attribute.Email;
    attendeeInfo: Schema.Attribute.Component<'attendee.attendee-info', false>;
    attendeeName: Schema.Attribute.String;
    ...
    ticketType: Schema.Attribute.Relation<
      'manyToOne',
      'api::ticket-type.ticket-type'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    invitationReminderSentAt: Schema.Attribute.DateTime &
      Schema.Attribute.Private;
