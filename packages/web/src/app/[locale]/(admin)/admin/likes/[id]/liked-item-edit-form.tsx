...
export default function LikedItemEditForm({ item }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!result.success) {
      toast.error(result.error || t("common.failedToUpdate", { entity: t("likes.entityName") }))
      setIsSubmitting(false)
      return
    }

    toast.success(t("common.updatedSuccess", { entity: t("likes.entityName") }))
    resetDirtyState()
    router.refresh()
    setIsSubmitting(false)
  }
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!result.success) {
      toast.error(result.error || t("likes.form.imageUploadFailed"))
    } else {
      toast.success(t("likes.form.imageUploadSuccess"))
      router.refresh()
    }
  ...
  const handleRemoveImage = async () => {
    ...
    if (!result.success) {
      toast.error(result.error || t("likes.form.imageRemoveFailed"))
    } else {
      toast.success(t("likes.form.imageRemoveSuccess"))
  ...
  const handleSaveAndNavigate = useCallback(async () => {
    ...
    setIsSubmitting(false)
  }, [item.documentId, name, description, url, contributors, toast, resetDirtyState, router, t])
  ...
  const handleDelete = async () => {
    ...
    if (!result.success) {
      toast.error(result.error || t("common.failedToDelete", { entity: t("likes.entityName") }))
      setIsDeleting(false)
      setShowDeleteConfirm(false)
      return
    }

    toast.success(t("common.deletedSuccess", { entity: t("likes.entityName") }))
      ...
      <div className="sponsor-edit-layout">
        <div className="sponsor-edit-details">
          <div className="admin-form-section">
            ...
            <div className="admin-form-row">
              <div className="admin-form-group">
                <label>{t("likes.form.imageLabel")}</label>
                  ...
                  {getImageUrl() ? (
                    ...
                    <div className="image-upload">
                      <label className="admin-btn admin-btn-secondary">
                        ...
                        {isUploadingImage ? t("likes.form.uploading") : t("likes.form.uploadImage")}
                        <input
                          type="file"
                          accept="image/*"
          ...
          <div className="admin-form-section">
            <h2>{t("likes.form.contributorsTitle")}</h2>
            <p className="admin-form-section-description">
              {t("likes.form.contributorsDescription")}
            </p>
              ...
              <div className="admin-form-group full-width">
                ...
                <div className="player-search">
                  <div className="search-input-wrapper">
                    ...
                    <input
                      type="text"
                      placeholder={t("likes.form.searchPlayers")}
                      value={playerSearch}
        ...
        <div className="sponsor-edit-actions">
          <div className="action-buttons">
            ...
            {!showDeleteConfirm && (
              ...
              >
                <i className="bx bx-trash" />
                {t("likes.edit.deleteButton")}
              </button>
            )}

            {showDeleteConfirm && (
              <div className="admin-delete-confirm">
                <span>{t("common.deleteConfirm", { entity: t("likes.entityName") })}</span>
                <button
                  type="button"
                  className="admin-btn admin-btn-danger admin-btn-block"
