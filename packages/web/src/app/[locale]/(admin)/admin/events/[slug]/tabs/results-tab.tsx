...
export default function ResultsTab({
  ...
  const t = useTranslations("adminEvents.results")
            ...
            <div className="actuals-item actuals-item-calculated">
              <div className="actuals-item-view">
                <div className="actuals-item-info">
                  ...
                  <span className="actuals-item-description">{t("ticketSalesCalculated")}</span>
                </div>
  ...
  return (
    <>
      ...
      <div className="admin-form-section">
        <h2>{t("financialResults")}</h2>
        <p className="admin-form-section-description">{t("financialResultsDescription")}</p>
        ...
        <div className={`actuals-result-card ${totals.result >= 0 ? "profit" : "loss"}`}>
          ...
          <div className="actuals-result-info">
            <span className="actuals-result-label">
              {totals.result >= 0 ? t("profit") : t("loss")}
            </span>
      ...
      <div className="admin-form-section">
        <h2>
          <i className="bx bx-trending-up" /> {t("incomeSection")}
        </h2>
        <p className="admin-form-section-description">{t("recordIncome")}</p>
      ...
      <div className="admin-form-section">
        <h2>
          <i className="bx bx-trending-down" /> {t("expensesSection")}
        </h2>
        <p className="admin-form-section-description">{t("recordExpenses")}</p>
