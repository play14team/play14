...
export default function EventCreateForm({ locations, venues }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isValid(startDateTime)) {
      toast.error(t("create.invalidStartDateTime"))
    ...
    if (!isValid(endDateTime)) {
      toast.error(t("create.invalidEndDateTime"))
      setIsSubmitting(false)
      return
    }
    ...
    if (!isAfter(endDateTime, startDateTime)) {
      toast.error(t("create.endAfterStart"))
      setIsSubmitting(false)
      return
    }
    ...
    if (locationMode === "existing") {
      if (!selectedLocationId) {
        toast.error(t("create.selectLocationError"))
        setIsSubmitting(false)
        return
      }
      ...
      if (!newLocationName.trim() || !newLocationCountry) {
        toast.error(t("create.provideLocationError"))
        setIsSubmitting(false)
        return
      }
      data.newLocation = {
    ...
    if (result.success && result.event) {
      ...
      toast.error(result.error || t("create.createdError"))
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="admin-form">
      <div className="admin-form-section">
        <h2>{t("create.eventDetails")}</h2>

        <div className="admin-form-group">
          <label htmlFor="name">{t("create.eventName")}</label>
          <input
            type="text"
            id="name"
            value={name}
        ...
        <div className="admin-form-row">
          ...
          <div className="admin-form-group">
            <label htmlFor="startTime">{t("create.startTime")}</label>
            <input
              type="time"
              id="startTime"
              value={startTime}
        ...
        <div className="admin-form-row">
          <div className="admin-form-group">
            ...
            <input
              ...
              className="admin-input"
            />
            <p className="admin-form-help">{t("create.endDateHelp")}</p>
          </div>

          <div className="admin-form-group">
            <label htmlFor="endTime">{t("create.endTime")}</label>
            <input
              type="time"
              id="endTime"
              value={endTime}
        ...
        <div className="admin-form-row">
          <div className="admin-form-group">
            <label htmlFor="timezone">{t("create.timezone")}</label>
            <select
              id="timezone"
              value={timezone}
        ...
        {endDatePreview && startDatePreview && (
          <div className="end-date-preview">
            ...
            <span>
              {t.rich("create.eventRunsFrom", {
                startDate: formatDate(startDatePreview),
                endDate: formatDate(endDatePreview),
                endTime: formatTime(endDatePreview),
      ...
      <div className="admin-form-section">
        ...
        <div className="admin-form-row">
          <label className="admin-radio-option">
            ...
            />
            <span>{t("create.selectExistingLocation")}</span>
          </label>
          <label className="admin-radio-option">
            <input
              type="radio"
            ...
            />
            <span>{t("create.createNewLocation")}</span>
          </label>
        </div>
        ...
        {locationMode === "existing" ? (
          ...
          <div className="admin-form-row">
            <div className="admin-form-group">
              <label htmlFor="newLocationName">{t("create.locationName")}</label>
              <input
                type="text"
                id="newLocationName"
                ...
                className="admin-input"
                placeholder={t("create.locationNamePlaceholder")}
      ...
      <div className="admin-form-section">
        <h2>{t("create.venueTitle")}</h2>
        <p className="admin-form-section-description">{t("create.venueDescription")}</p>
        ...
        <div className="admin-form-row">
          ...
          <label className="admin-radio-option">
            ...
            />
            <span>{t("create.selectExistingVenue")}</span>
          </label>
          <label className="admin-radio-option">
            <input
              type="radio"
            ...
            />
            <span>{t("create.createNewVenue")}</span>
          </label>
        </div>

        {venueMode === "existing" && (
          <div className="admin-form-group">
            <label htmlFor="venue">{t("create.venue")}</label>
            <select
              id="venue"
              ...
              className="admin-select"
            >
              <option value="">{t("create.selectVenue")}</option>
              {venues.map((v) => (
        ...
        {venueMode === "new" && (
          <div className="admin-form-row">
            <div className="admin-form-group">
              <label htmlFor="newVenueName">{t("create.venueName")}</label>
              <input
                type="text"
                id="newVenueName"
                value={newVenueName}
                ...
                className="admin-input"
                placeholder={t("create.venueNamePlaceholder")}
              />
            </div>
            <div className="admin-form-group">
              <label htmlFor="newVenueAddress">{t("create.addressDetails")}</label>
              <input
                type="text"
                id="newVenueAddress"
      ...
      <div className="admin-form-section">
        <h2>{t("create.descriptionTitle")}</h2>
      ...
      <div className="admin-form-section admin-info-section">
        <h2>{t("create.whatHappensNext")}</h2>
        <ul>
          <li>
