...
export default function TicketTypeEditor({ eventId, ticketTypes, onUpdate }: Props) {
  const t = useTranslations("adminEvents.ticketTypes")
  ...
  const handleDrop = async (event: DragEvent<HTMLDivElement>, targetId: string) => {
    ...
    if (result.success) {
      ...
      setError(result.error || t("failedToReorder"))
  ...
  return (
    <div className="ticket-type-editor">
                ...
                <>
                  ...
                  <div className="ticket-type-info">
                    <div className="ticket-type-header">
                      ...
                      {!ticket.isActive && (
                        <span className="ticket-badge inactive">{t("inactive")}</span>
                      )}
                      {ticket.soldCount > 0 && (
                        <span className="ticket-badge sold">
                          {t("sold", { sold: ticket.soldCount })}
                        </span>
                      )}
                    </div>
                    {ticket.description && (
                    ...
                    <div className="ticket-type-details">
                      ...
                      {ticket.capacity && (
                        <span className="ticket-capacity">
                          {t("available", {
                            available: `${ticket.capacity - ticket.soldCount} / ${ticket.capacity}`,
                          })}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="ticket-type-actions">
                    ...
                    <button
                      ...
                      className="admin-btn admin-btn-icon"
                      title={ticket.isActive ? t("deactivate") : t("activate")}
                    >
                    ...
                    <button
                      ...
                      title={ticket.soldCount > 0 ? t("cannotDeleteSold") : t("delete")}
                    >
          ...
          <div className="ticket-type-form">
            ...
            <div className="ticket-type-actions">
              <button
                ...
                className="admin-btn admin-btn-primary admin-btn-sm"
              >
                {isLoading ? t("creating") : t("createTicketType")}
              </button>
              <button
                type="button"
                onClick={resetForm}
      ...
      <ConfirmationDialog
        ...
        title={t("deleteTitle")}
        message={t("deleteConfirm", { name: deleteConfirmation.ticketName })}
