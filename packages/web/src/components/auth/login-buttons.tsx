...
export default function LoginButtons({
  ...
  const handleLogin = (url: string) => {
    // Store callback URL in sessionStorage for after OAuth redirect
  ...
  return (
    <div className="auth-login-buttons">
      <button
        type="button"
        className="auth-login-btn auth-login-btn-google"
        onClick={() => handleLogin(googleUrl)}
      >
        <svg className="auth-login-btn-icon" viewBox="0 0 24 24" width="20" height="20">
          <path
            fill="currentColor"
      ...
      <button
        type="button"
        className="auth-login-btn auth-login-btn-github"
      ...
      <button
        type="button"
        className="auth-login-btn auth-login-btn-linkedin"
        onClick={() => handleLogin(linkedinUrl)}
      >
        <svg className="auth-login-btn-icon" viewBox="0 0 24 24" width="20" height="20">
          <path
            fill="currentColor"
