  ...
  return (
    <aside className="game-profile-sidebar">
      ...
      <div className="game-profile-sidebar__card">
        <h3 className="game-profile-sidebar__title">Game info</h3>
        <ul className="game-profile-sidebar__list">
          {/* Duration */}
          <li className="game-profile-sidebar__item">
            <i className="bx bx-time" aria-hidden="true" />
            <span className="game-profile-sidebar__label">Duration</span>
            <span className="game-profile-sidebar__value">{game.timebox || "Not specified"}</span>
          </li>

          {/* Group size */}
          <li className="game-profile-sidebar__item">
            <i className="bx bx-group" aria-hidden="true" />
            <span className="game-profile-sidebar__label">Group size</span>
            <span className="game-profile-sidebar__value">{game.scale || "Any"}</span>
          </li>
          ...
          {game.firstPlayedAt && (
            <li className="game-profile-sidebar__item">
              ...
              <span className="game-profile-sidebar__label">First played</span>
              <Link
          ...
          {game.credits && (
            <li className="game-profile-sidebar__item">
              ...
              <span className="game-profile-sidebar__label">Credits</span>
      ...
      {hasRatings && (
        <div className="game-profile-sidebar__card">
          <h3 className="game-profile-sidebar__title">Ratings</h3>
      ...
      {hasContributors && (
        <div className="game-profile-sidebar__card">
          <h3 className="game-profile-sidebar__title">Contributors</h3>

          {/* Proposed by */}
          {game.proposedBy && game.proposedBy.length > 0 && (
            <div className="game-profile-sidebar__contributors">
              <span className="game-profile-sidebar__contributor-label">Proposed by</span>
          ...
          {game.documentedBy && game.documentedBy.length > 0 && (
            <div className="game-profile-sidebar__contributors">
              <span className="game-profile-sidebar__contributor-label">Documented by</span>
      ...
      {hasResources && (
        <div className="game-profile-sidebar__card">
          <h3 className="game-profile-sidebar__title">Resources</h3>
