  ...
  return [
    {
      ...
      items: [
        { label: t("home"), href: "/" },
        { label: t("whatItIs"), href: "/#power-of-play" },
        { label: t("whoYoullMeet"), href: "/#join-the-movement" },
        { label: t("upcomingEvents"), href: "/#upcoming-events" },
        { label: t("statistics"), href: "/#statistics" },
        { label: t("worldMap"), href: "/#world-map" },
        { label: t("whatASessionCanBe"), href: "/#activities" },
        { label: t("whatYouTakeHome"), href: "/#takeaways" },
