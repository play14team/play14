const Manifesto = () => {
  return (
    <div className="single-funfacts-box">
      ...
      <ul>
        <li>
          <i className="bx bx-share-alt blue" aria-hidden="true"></i> a place
          to <strong>share knowledge &amp; practices</strong> more than a place
          to sell services &amp; goods
        </li>
        <li>
        ...
        <li>
          <i className="bx bx-world orange" aria-hidden="true"></i> focused on{" "}
